          ...
          {success ? (
            ...
            <form onSubmit={handleSubmit} style={{maxWidth:380,margin:'0 auto',textAlign:'left'}}>
              <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:12,marginBottom:12}}>
                <div>
                  <label style={{fontSize:10,color:'rgba(246,246,244,.35)',letterSpacing:2.5,textTransform:'uppercase',fontWeight:600,display:'block',marginBottom:8}}>Nome</label>
                ...
                <div>
                  <label style={{fontSize:10,color:'rgba(246,246,244,.35)',letterSpacing:2.5,textTransform:'uppercase',fontWeight:600,display:'block',marginBottom:8}}>Cognome</label>
              ...
              <div style={{marginBottom:12}}>
                <label style={{fontSize:10,color:'rgba(246,246,244,.35)',letterSpacing:2.5,textTransform:'uppercase',fontWeight:600,display:'block',marginBottom:8}}>Email</label>
              ...
              <div style={{marginBottom:16}}>
                <label style={{fontSize:10,color:'rgba(246,246,244,.35)',letterSpacing:2.5,textTransform:'uppercase',fontWeight:600,display:'block',marginBottom:8}}>Telefono</label>
              ...
              {/* Privacy */}
              <label style={{display:'flex',alignItems:'flex-start',gap:10,marginBottom:20,cursor:'pointer',padding:'4px 0'}}>
                <input type="checkbox" checked={privacy} onChange={e=>{setPrivacy(e.target.checked);setErrors(prev=>({...prev,privacy:false}))}} style={{accentColor:'#F4C430',width:16,height:16,marginTop:2,flexShrink:0}}/>
